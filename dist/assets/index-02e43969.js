 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Or=new Vf("@firebase/app"),yR="@firebase/app-compat",_R="@firebase/analytics-compat",vR="@firebase/analytics",wR="@firebase/app-check-compat",ER="@firebase/app-check",AR="@firebase/auth",IR="@firebase/auth-compat",TR="@firebase/database",RR="@firebase/database-compat",SR="@firebase/functions",CR="@firebase/functions-compat",PR="@firebase/installations",kR="@firebase/installations-compat",NR="@firebase/messaging",DR="@firebase/messaging-compat",xR="@firebase/performance",OR="@firebase/performance-compat",VR="@firebase/remote-config",LR="@firebase/remote-config-compat",MR="@firebase/storage",UR="@firebase/storage-compat",bR="@firebase/firestore",FR="@firebase/firestore-compat",jR="firebase",BR="10.4.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const sd="[DEFAULT]",zR={[id]:"fire-core",[yR]:"fire-core-compat",[vR]:"fire-analytics",[_R]:"fire-analytics-compat",[ER]:"fire-app-check",[wR]:"fire-app-check-compat",[AR]:"fire-auth",[IR]:"fire-auth-compat",[TR]:"fire-rtdb",[RR]:"fire-rtdb-compat",[SR]:"fire-fn",[CR]:"fire-fn-compat",[PR]:"fire-iid",[kR]:"fire-iid-compat",[NR]:"fire-fcm",[DR]:"fire-fcm-compat",[xR]:"fire-perf",[OR]:"fire-perf-compat",[VR]:"fire-rc",[LR]:"fire-rc-compat",[MR]:"fire-gcs",[UR]:"fire-gcs-compat",[bR]:"fire-fst",[FR]:"fire-fst-compat","fire-js":"fire-js",[jR]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ad(){var t;return typeof self<"u"&&((t=self.location)===null||t===void 0?void 0:t.href)||""}function sS(){return Ig()==="http:"||Ig()==="https:"}function Ig(){var t;return typeof self<"u"&&((t=self.location)===null||t===void 0?void 0:t.protocol)||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Sg(t){const e=t.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(O0(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(D0(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(L0(e))return"Blackberry";if(M0(e))return"Webos";if(Bf(e))return"Safari";if((e.includes("chrome/")||x0(e))&&!e.includes("edge/"))return"Chrome";if(V0(e))return"Android";{const n=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,r=t.match(n);if((r==null?void 0:r.length)===2)return r[1]}return"Other"}function D0(t=Ye()){return/firefox\//i.test(t)}function Bf(t=Ye()){const e=t.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function x0(t=Ye()){return/crios\//i.test(t)}function O0(t=Ye()){return/iemobile/i.test(t)}function V0(t=Ye()){return/android/i.test(t)}function L0(t=Ye()){return/blackberry/i.test(t)}function M0(t=Ye()){return/webos/i.test(t)}function Au(t=Ye()){return/iphone|ipad|ipod/i.test(t)||/macintosh/i.test(t)&&/mobile/i.test(t)}function AS(t=Ye()){var e;return Au(t)&&!!(!((e=window.navigator)===null||e===void 0)&&e.standalone)}function IS(){return j1()&&document.documentMode===10}function U0(t=Ye()){return Au(t)||V0(t)||M0(t)||L0(t)||/windows phone/i.test(t)||O0(t)}function TS(){try{return!!(window&&window!==window.top)}catch{return!1}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Dx{constructor(e,n,r,i,s){this.localStore=e,this.datastore=n,this.asyncQueue=r,this.remoteSyncer={},this.C_=[],this.v_=new Map,this.F_=new Set,this.M_=[],this.x_=s,this.x_.so(o=>{r.enqueueAndForget(async()=>{Qr(this)&&(V("RemoteStore","Restarting streams for network reachability change."),await async function(l){const u=j(l);u.F_.add(4),await sa(u),u.O_.set("Unknown"),u.F_.delete(4),await Yu(u)}(this))})}),this.O_=new Nx(r,i)}}async function Yu(t){if(Qr(t))for(const e of t.M_)await e(!0)}async function sa(t){for(const e of t.M_)await e(!1)}function fA(t,e){const n=j(t);n.v_.has(e.targetId)||(n.v_.set(e.targetId,e),Lp(n)?Vp(n):ns(n).Yo()&&Op(n,e))}function pA(t,e){const n=j(t),r=ns(n);n.v_.delete(e),r.Yo()&&mA(n,e),n.v_.size===0&&(r.Yo()?r.e_():Qr(n)&&n.O_.set("Unknown"))}function Op(t,e){if(t.N_.Le(e.targetId),e.resumeToken.approximateByteSize()>0||e.snapshotVersion.compareTo(F.min())>0){const n=t.remoteSyncer.getRemoteKeysForTarget(e.targetId).size;e=e.withExpectedCount(n)}ns(t).l_(e)}function mA(t,e){t.N_.Le(e),ns(t).h_(e)}function Vp(t){t.N_=new OD({getRemoteKeysForTarget:e=>t.remoteSyncer.getRemoteKeysForTarget(e),lt:e=>t.v_.get(e)||null,st:()=>t.datastore.serializer.databaseId}),ns(t).start(),t.O_.y_()}function Lp(t){return Qr(t)&&!ns(t).Jo()&&t.v_.size>0}function Qr(t){return j(t).F_.size===0}function gA(t){t.N_=void 0}async function xx(t){t.v_.forEach((e,n)=>{Op(t,e)})}async function Ox(t,e){gA(t),Lp(t)?(t.O_.b_(e),Vp(t)):t.O_.set("Unknown")}async function Vx(t,e,n){if(t.O_.set("Online"),e instanceof nA&&e.state===2&&e.cause)try{await async function(i,s){const o=s.cause;for(const a of s.targetIds)i.v_.has(a)&&(await i.remoteSyncer.rejectListen(a,o),i.v_.delete(a),i.N_.removeTarget(a))}(t,e)}catch(r){V("RemoteStore","Failed to remove targets %s: %s ",e.targetIds.join(","),r),await Xl(t,r)}else if(e instanceof il?t.N_.Ge(e):e instanceof tA?t.N_.Xe(e):t.N_.He(e),!n.isEqual(F.min()))try{const r=await cA(t.localStore);n.compareTo(r)>=0&&await function(s,o){const a=s.N_._t(o);return a.targetChanges.forEach((l,u)=>{if(l.resumeToken.approximateByteSize()>0){const c=s.v_.get(u);c&&s.v_.set(u,c.withResumeToken(l.resumeToken,o))}}),a.targetMismatches.forEach((l,u)=>{const c=s.v_.get(l);if(!c)return;s.v_.set(l,c.withResumeToken(Xe.EMPTY_BYTE_STRING,c.snapshotVersion)),mA(s,l);const h=new Un(c.target,l,u,c.sequenceNumber);Op(s,h)}),s.remoteSyncer.applyRemoteEvent(a)}(t,n)}catch(r){V("RemoteStore","Failed to raise snapshot:",r),await Xl(t,r)}}async function Xl(t,e,n){if(!ta(e))throw e;t.F_.add(1),await sa(t),t.O_.set("Offline"),n||(n=()=>cA(t.localStore)),t.asyncQueue.enqueueRetryable(async()=>{V("RemoteStore","Retrying IndexedDB access"),await n(),t.F_.delete(1),await Yu(t)})}function yA(t,e){return e().catch(n=>Xl(t,n,e))}async function Xu(t){const e=j(t),n=nr(e);let r=e.C_.length>0?e.C_[e.C_.length-1].batchId:-1;for(;Lx(e);)try{const i=await vx(e.localStore,r);if(i===null){e.C_.length===0&&n.e_();break}r=i.batchId,Mx(e,i)}catch(i){await Xl(e,i)}_A(e)&&vA(e)}function Lx(t){return Qr(t)&&t.C_.length<10}function Mx(t,e){t.C_.push(e);const n=nr(t);n.Yo()&&n.I_&&n.d_(e.mutations)}function _A(t){return Qr(t)&&!nr(t).Jo()&&t.C_.length>0}function vA(t){nr(t).start()}async function Ux(t){nr(t).A_()}async function bx(t){const e=nr(t);for(const n of t.C_)e.d_(n.mutations)}async function Fx(t,e,n){const r=t.C_.shift(),i=Cp.from(r,e,n);await yA(t,()=>t.remoteSyncer.applySuccessfulWrite(i)),await Xu(t)}async function jx(t,e){e&&nr(t).I_&&await async function(r,i){if(function(o){return ND(o)&&o!==E.ABORTED}(i.code)){const s=r.C_.shift();nr(r).Xo(),await yA(r,()=>r.remoteSyncer.rejectFailedWrite(s.batchId,i)),await Xu(r)}}(t,e),_A(t)&&vA(t)}async function ky(t,e){const n=j(t);n.asyncQueue.verifyOperationInProgress(),V("RemoteStore","RemoteStore received new credentials");const r=Qr(n);n.F_.add(3),await sa(n),r&&n.O_.set("Unknown"),await n.remoteSyncer.handleCredentialChange(e),n.F_.delete(3),await Yu(n)}async function Bx(t,e){const n=j(t);e?(n.F_.delete(2),await Yu(n)):e||(n.F_.add(2),await sa(n),n.O_.set("Unknown"))}function ns(t){return t.B_||(t.B_=function(n,r,i){const s=j(n);return s.V_(),new Cx(r,s.connection,s.authCredentials,s.appCheckCredentials,s.serializer,i)}(t.datastore,t.asyncQueue,{Io:xx.bind(null,t),Eo:Ox.bind(null,t),c_:Vx.bind(null,t)}),t.M_.push(async e=>{e?(t.B_.Xo(),Lp(t)?Vp(t):t.O_.set("Unknown")):(await t.B_.stop(),gA(t))})),t.B_}function nr(t){return t.L_||(t.L_=function(n,r,i){const s=j(n);return s.V_(),new Px(r,s.connection,s.authCredentials,s.appCheckCredentials,s.serializer,i)}(t.datastore,t.asyncQueue,{Io:Ux.bind(null,t),Eo:jx.bind(null,t),E_:bx.bind(null,t),T_:Fx.bind(null,t)}),t.M_.push(async e=>{e?(t.L_.Xo(),await Xu(t)):(await t.L_.stop(),t.C_.length>0&&(V("RemoteStore",`Stopping write stream with ${t.C_.length} pending writes`),t.C_=[]))})),t.L_}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
